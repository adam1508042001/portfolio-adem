...
const Projects = ref([
    ...
    {
        id: 2,
image: 'https://www.pagesjaunes.fr/media/agc/resize/403x550/c4/0c/72/00/00/9d/9a/a0/c6/2e/6384c40c7200009d9aa0c62e/6384c40c7200009d9aa0c62f.jpg',
        title: 'Landing page',
        description: 'Landing page de la compagne marketing de RESEAU EXPRESS',
        technologies: [ 'Tailwind CSS', 'HTML' , 'JS'],
        gitURL: '',
        webURL: 'https://www.reseau-express.fr/coursiers.htm'
    }
